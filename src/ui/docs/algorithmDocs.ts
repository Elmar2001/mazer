...
export const ALGORITHM_DOCS: AlgorithmDoc[] = [
  ...
  },
  {
    ...
    kind: "Generator",
    summary: "Prim variant that samples random frontier edges directly.",
    howItWorks: [
      "Seed one visited root cell.",
      "Push root->unvisited frontier edges.",
      "Pick random edge and carve when target is unvisited.",
      "Repeat until frontier is exhausted.",
    ],
    timeComplexity: "O(E) expected",
    spaceComplexity: "O(E)",
    pros: ["Classic Prim behavior", "Good branching texture"],
    cons: ["Large frontier edge list", "Needs stale-edge filtering"],
    bestFor: "True edge-frontier Prim demonstrations.",
    interestingFact:
      "Edge-frontier Prim and cell-frontier Prim can produce noticeably different local motifs.",
  },
  {
    id: "prim-simplified",
    name: "Prim (Simplified)",
    kind: "Generator",
    summary: "Frontier-cell Prim using lighter bookkeeping than edge-frontier mode.",
    howItWorks: [
      "Track frontier cells near visited territory.",
      "Pick random frontier cell.",
      "Connect it to one visited neighbor.",
      "Add newly exposed frontier cells.",
    ],
    timeComplexity: "O(V) expected",
    spaceComplexity: "O(V)",
    pros: ["Simple implementation", "Strong maze branching"],
    cons: ["Less canonical than true edge Prim", "Can look noisy"],
    bestFor: "Practical Prim-style generation with less overhead.",
    interestingFact:
      "This style is common in visualizers because frontier bookkeeping is straightforward.",
  },
  {
    id: "prim-modified",
    name: "Prim (Modified)",
  ...
  },
  {
    ...
    name: "Flood Fill",
    kind: "Solver",
    summary: "Floods distance labels, then follows descending gradient to goal.",
    howItWorks: [
    ...
    timeComplexity: "O(V + E)",
    spaceComplexity: "O(V)",
    pros: ["Shortest path in unweighted mazes", "Clear wave visualization"],
    cons: ["Needs full distance map", "Can expand broad regions"],
    bestFor: "Micromouse-style distance-field solving demonstrations.",
    interestingFact:
      "Flood fill and Lee wavefront are closely related formulations on grid graphs.",
  },
  {
    id: "pledge",
  ...
  },
  {
    ...
    name: "Chain",
    kind: "Solver",
    summary: "Global-map style chaining method that links expansion fronts.",
    howItWorks: [
    ...
    timeComplexity: "Implementation-dependent",
    spaceComplexity: "O(V)",
    pros: ["Global structural reasoning", "Useful for comparative studies"],
    cons: ["Less common in mainstream libraries", "Harder to implement cleanly"],
    bestFor: "Advanced solver comparison sets.",
    interestingFact:
      "Chain-style methods are documented in Think Labyrinth as broad-topology solvers.",
  },
  {
  ...
  },
  {
    ...
    kind: "Solver",
    summary: "Seals blind alleys to reveal viable route corridors.",
    howItWorks: [
    ...
    timeComplexity: "O(V + E)",
    spaceComplexity: "O(V)",
    pros: ["Strong structural interpretation", "Highlights non-solution regions"],
    cons: ["Requires global map view", "Less direct than shortest-path search"],
    bestFor: "Structural maze analysis and elimination visuals.",
    interestingFact:
      "Sealer variants preserve structural context while removing navigational noise.",
  },
  {
    id: "blind-alley-filler",
    name: "Blind Alley Filler",
    kind: "Solver",
    summary: "Fills blind alleys iteratively, leaving only viable route cores.",
    howItWorks: [
    ...
    timeComplexity: "O(V + E)",
    spaceComplexity: "O(V)",
    pros: ["Simple elimination concept", "Works well in map-view mode"],
    cons: ["Not a local in-maze strategy", "Can be slower than direct search"],
    bestFor: "Comparing elimination solvers with search-based solvers.",
    interestingFact:
      "Blind alley filling is conceptually similar to iterative graph leaf removal.",
  },
  {
    id: "collision-solver",
    name: "Collision Solver",
    kind: "Solver",
    summary: "Expands from both ends and solves where search waves collide.",
    howItWorks: [
    ...
    timeComplexity: "Near bidirectional BFS behavior",
    spaceComplexity: "O(V)",
    pros: ["Fast for distant endpoints", "Natural two-wave visualization"],
    cons: ["More merge bookkeeping", "Depends on collision tie handling"],
    bestFor: "Bidirectional shortest-path comparisons.",
    interestingFact:
      "Collision-style solving is closely tied to bidirectional search theory.",
  },
  {
  ...
  },
  {
    ...
    kind: "Solver",
    summary: "Finds one shortest route from start to goal.",
    howItWorks: [
    ...
    spaceComplexity: "O(V)",
    pros: ["Deterministic and optimal", "Low conceptual overhead"],
    cons: ["Returns one path only", "Does not enumerate all optimal alternatives"],
